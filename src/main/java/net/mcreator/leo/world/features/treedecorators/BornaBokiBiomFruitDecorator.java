...
public class BornaBokiBiomFruitDecorator extends CocoaDecorator {
	public static final BornaBokiBiomFruitDecorator INSTANCE = new BornaBokiBiomFruitDecorator();
	public static com.mojang.serialization.Codec<BornaBokiBiomFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("borna_boki_biom_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public BornaBokiBiomFruitDecorator() {
		super(0.2f);
	}
