...
public class BornaBokiBiomLeaveDecorator extends LeaveVineDecorator {
	public static final BornaBokiBiomLeaveDecorator INSTANCE = new BornaBokiBiomLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("borna_boki_biom_tree_leave_decorator");
